...
namespace LabOOP3
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("ЛАБОРАТОРНА РОБОТА 3.2. ДОСЛІДЖЕННЯ КОЛЕКЦІЙ");
            Console.WriteLine("Виконує студент групи ІПЗ-XX, ПІБ\n");
            ...
            // --- Завдання 2: Демонстрація роботи з колекціями ---
            DemonstrateCollections(student1, student2, student3);

            // --- Завдання 3 і 4: Демонстрація роботи з бінарним деревом ---
            DemonstrateBinaryTree(student1, student2, student3);
        }

        /// <summary>
        /// Метод для демонстрації операцій з масивом, List<T> та ArrayList.
        /// </summary>
        ...
        /// <summary>
        /// Метод для демонстрації створення та обходу бінарного дерева.
        /// </summary>
